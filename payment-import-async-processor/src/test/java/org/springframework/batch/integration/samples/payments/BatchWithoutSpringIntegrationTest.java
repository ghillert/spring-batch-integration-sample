...
@ActiveProfiles("without-spring-integration")
public class BatchWithoutSpringIntegrationTest {
	...
	public void runBatch() throws Exception {
		...
		JobExecution jobExecution = ((Message<JobExecution>) statusesChannel.receive(120_000)).getPayload();
